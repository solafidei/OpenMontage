...
| `image_selector` | All tools with `capability="image_generation"` (FLUX, Google Gemini image via `google_imagen`, GPT Image, Recraft, etc.) | `registry.get_by_capability("image_generation")` |
