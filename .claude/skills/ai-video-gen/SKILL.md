...
| VEO 3 | `"veo3"` | Google VEO 3 — legacy: Google shut down `veo-3.0-generate-001` on the Gemini API on 2026-06-30; prefer `veo_3_1` |
| VEO 3 Fast | `"veo3_fast"` | Faster VEO 3 variant — legacy: Google shut down `veo-3.0-fast-generate-001` on the Gemini API on 2026-06-30; prefer `veo_3_1_fast` |
| VEO 2 | `"veo2"` | Google VEO 2 — legacy: Google shut down `veo-2.0-generate-001` on the Gemini API on 2026-06-30; prefer `veo_3_1` |
